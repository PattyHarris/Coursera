...
public class MainActivity extends LifecycleLoggingActivity {
    ...
    Intent downloadImageIntent, galleryIntent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mUrlButton = (Button) findViewById(R.id.button1);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        // code.
        	...
        	Toast.makeText(this, "Image download failed, url may point to nowhere", Toast.LENGTH_LONG).show();
        	return;
        }
    }    
    ...
    private Intent makeDownloadImageIntent(Uri url) {
    	...
    	downloadImageIntent = new Intent(this,DownloadImageActivity.class);
