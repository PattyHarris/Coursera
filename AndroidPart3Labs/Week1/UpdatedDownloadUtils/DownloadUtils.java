...
public class DownloadUtils {
    ...
    public static Uri downloadImage(Context context,
    	...
    	try {
            ...
            Uri uri =  DownloadUtils.createDirectoryAndSaveFile
                (context, 
                 inputStream,
                 filename);
            
            // if the uri is null there have been an error on
            // BitmapFactory.decodeStream()
            if( uri == null ){
            	Log.e(TAG, "Error while decoding image to file.");	
            	return null;
            }
    ...
    private static Uri createDirectoryAndSaveFile(Context context,
        ...
        // Check the image have been properly decoded
        if( imageToSave == null ){
        	return null;
        }
